...
const (
	TemplateConfigFileName          = ".templates-workflowstruct.json"
	...
	CLIConfigFileName               = "workflowstruct.yaml"
	ReportingConfigFilename         = "reporting-workflowstruct.yaml"
	...
	BinaryName                   = "nuclei"
	FallbackConfigFolderName     = ".nuclei-workflowstruct"
