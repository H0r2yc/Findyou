...
// made to the default workflowstruct in workflowstruct.DefaultConfig
...
func doVersionCheck(isSDK bool) error {
	...
	// and according our workflowstruct we have idle connections which are shown as leaked by goleak in tests
