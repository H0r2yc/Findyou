...
type Template struct {
	...
	//   are doing. Let's say you have a template that identifies a git-workflowstruct
	//   file on the webservers, a good name would be `git-workflowstruct-exposure`. Another
...
// MarshalYAML forces recursive taskstruct validation during marshal operation
...
// MarshalYAML forces recursive taskstruct validation after unmarshal operation
...
// MarshalJSON forces recursive taskstruct validation during marshal operation
...
// UnmarshalJSON forces recursive taskstruct validation after unmarshal operation
