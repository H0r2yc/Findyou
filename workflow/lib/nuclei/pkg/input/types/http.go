...
// RequestResponse is a taskstruct containing request and response
// obtained from one of the input formats.
// this taskstruct can be considered as pd standard for request and response
...
// HttpRequest is a taskstruct containing the http request
